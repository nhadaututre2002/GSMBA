...
type Props = NativeStackScreenProps<RootStackParamList, 'DataHistory'> & {
  route: RouteProp<RootStackParamList, 'DataHistory'>;
}
...
const DataHistory: React.FC<Props> = ({ navigation, route }) => {
